...
class MultiNonSep(nn.Module):
    ...
    def forward(self, inp):
        ...
        ## get object map
        heatmap, global_coeffs = self.heatmap_model((embeddings, text))
        ...
        map_pred = torch.cat( (obj_local, obj_global), 1 )
        # pdb.set_trace()
